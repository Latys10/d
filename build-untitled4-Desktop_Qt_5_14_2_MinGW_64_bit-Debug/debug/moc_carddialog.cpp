...
#include <memory>
#include "../../untitled4/carddialog.h"
...
QT_MOC_LITERAL(1, 11, 14), // "printRequested"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 15), // "cancelRequested"
QT_MOC_LITERAL(4, 43, 20), // "onPrintButtonClicked"
QT_MOC_LITERAL(5, 64, 21) // "onCancelButtonClicked"

    },
    "CardDialog\0printRequested\0\0cancelRequested\0"
    "onPrintButtonClicked\0onCancelButtonClicked"
};
...
void CardDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CardDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CardDialog::printRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CardDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CardDialog::cancelRequested)) {
                *result = 1;
                return;
            }
        }
